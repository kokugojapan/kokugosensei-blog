...
1つめは、記述問題を解く前に「要素は何個必要そうか」を口に出させることです。字数と設問条件から先に予想させると、集める材料の数に意識が向きます。

2つめは、丸つけの際に「要素がいくつ拾えていたか」を数えることです。丸バツではなく、拾えた要素の数で振り返ると、本文のどこを見落としていたかが具体的に分かります。

3つめは、傍線部だけを隠して前後の文だけを読ませる練習です。傍線部に頼らず前後の文脈から意味を推測する力がつくと、要素を拾える範囲が自然と広がっていきます。
